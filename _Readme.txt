...
!!! Для выбора лучшей модели использовался ощыеудин общий пайплайн для всех моделей и инструмент подбора гиперпараметров, который вернул лучшую модель: SVC(C=1, kernel='poly', probability=True)